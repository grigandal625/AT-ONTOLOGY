...
from at_ontology_parser.model.definitions import ConstraintDefinition, PropertyDefinition, ArtifactDefinition
...
class OntologyModelService:
    ...
    def data_type_source_from_db(data_type: models.DataType) -> dict:
        return {
            ...
            "constraints": [
                constraint.data
                for constraint in data_type.constraints.all()
            ] if data_type.constraints.all().exists() else None,
    ...
    def data_types_source_from_db(data_types: Iterable[models.DataType]) -> dict:
        return {
            data_type.name: OntologyModelService.data_type_source_from_db(data_type)
    ...
    @staticmethod
    def artifact_definition_source_from_db(artifact: models.VertexTypeArtifactDefinition | models.RelationshipTypeArtifactDefinition) -> dict:
        return {
    ...
    def artifacts_source_from_db(artifacts: Iterable[models.ArtifactDefinition]) -> dict:
        return {
            artifact.name: OntologyModelService.artifact_definition_source_from_db(artifact)
            for artifact in artifacts
        }
    
    @staticmethod
    def property_definition_source_from_db(property: models.VertexTypePropertyDefinition | models.RelationshipTypePropertyDefinition) -> dict:
        return {
    ...
    def properties_source_from_db(properties: Iterable[models.PropertyDefinition]) -> dict:
        return {
            property.name: OntologyModelService.property_definition_source_from_db(property)
    ...
    def ontology_model_source_from_db(ontology_model: models.OntologyModel) -> dict:
        return {
            ...
            "relationship_types": OntologyModelService.relationship_types_source_from_db(ontology_model.relationship_types.all()),
        }
    ...
    def data_type_to_db(data_type: DataType, ontology_model: models.OntologyModel) -> models.DataType:
        ...
        except models.DataType.MultipleObjectsReturned:
    ...
    @staticmethod
    def get_derived_from_data_type(derived_from: Optional[OntologyReference[DataType]], ontology_model: models.OntologyModel) -> Optional[models.DataType]:
        if derived_from:
    ...
    @staticmethod
    def get_importing_models_queryset_deep(ontology_model: models.OntologyModel, watched: QuerySet[models.OntologyModel] = None) -> QuerySet[models.OntologyModel]:
    ...
    @staticmethod
    def get_derived_from_vertex(derived_from: Optional[OntologyReference[VertexType]], ontology_model: models.OntologyModel) -> Optional[models.VertexType]:
        if derived_from:
    ...
    @staticmethod
    @atomic
    def vertex_type_property_definition_to_db(property: PropertyDefinition, vertex_type: VertexType, ontology_model: models.OntologyModel) -> models.VertexTypePropertyDefinition:
    ...
    @staticmethod
    @atomic
    def vertex_type_artifact_definition_to_db(artifact: ArtifactDefinition, vertex_type: VertexType, ontology_model: models.OntologyModel) -> models.VertexTypeArtifactDefinition:
    ...
    @staticmethod
    @atomic
    def relationship_type_to_db(relationship_type: RelationshipType, ontology_model: models.OntologyModel) -> models.RelationshipType:
        try:
            derived_from = OntologyModelService.get_derived_from_relationship_type(relationship_type.derived_from, ontology_model)
        except models.RelationshipType.DoesNotExist:
            raise CreateModelException(_("relationship_type_not_exists{name}").format(name=relationship_type.derived_from.alias))
        except models.RelationshipType.MultipleObjectsReturned:
            raise BrokenModelException(_("relationship_type_multiple{name}").format(name=relationship_type.derived_from.alias))
        ...
        if relationship_type.valid_source_types:
            result.valid_source_types.add(
                OntologyModelService.get_vertex_types_queryset(
                    names=[ref.alias for ref in relationship_type.valid_source_types], 
                    ontology_model=ontology_model
                )
            )
        ...
        if relationship_type.valid_target_types:
            result.valid_target_types.add(
                OntologyModelService.get_vertex_types_queryset(
                    names=[ref.alias for ref in relationship_type.valid_target_types], 
                    ontology_model=ontology_model
                )
            )
    ...
    @staticmethod
    def get_derived_from_relationship_type(derived_from: Optional[OntologyReference[RelationshipType]], ontology_model: models.OntologyModel) -> Optional[models.RelationshipType]:
        if derived_from:
    ...
    @staticmethod
    def relationship_type_property_definition_to_db(property: PropertyDefinition, relationship_type: RelationshipType) -> models.RelationshipTypePropertyDefinition:
    ...
    @staticmethod
    def relationship_type_artifact_definition_to_db(artifact: ArtifactDefinition, relationship_type: RelationshipType) -> models.RelationshipTypeArtifactDefinition:
    ...
    @staticmethod
    def get_vertex_types_queryset(names: list[str], ontology_model: models.OntologyModel) -> QuerySet[models.VertexType]:
