    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.CharField(help_text="Путь или имя файла для импорта", max_length=1024),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "required",
                    models.BooleanField(default=False, help_text="Обязательное ли это свойство"),
                ),
                (
                    "default",
                    models.JSONField(blank=True, help_text="Значение по умолчанию", null=True),
                ),
                (
                    "initializable",
                    models.BooleanField(
                ...
                (
                    "allows_multiple",
                    models.BooleanField(default=True, help_text="Разрешать несколько значений"),
                ),
                (
                    "min_assignments",
                    models.IntegerField(blank=True, help_text="Минимальное число присвоений", null=True),
                ),
                (
                    "max_assignments",
                    models.IntegerField(blank=True, help_text="Максимальное число присвоений", null=True),
                ),
                (
                    "owner",
                    models.ForeignKey(
