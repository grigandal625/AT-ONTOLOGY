...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        competence_type = self.create_vertex_type(name="Компетенция", ontology_model=ontology_model)
        ...
        for code, description in rows:
            Vertex.objects.get_or_create(name=code, type=competence_type, description=description, ontology=ontology)
