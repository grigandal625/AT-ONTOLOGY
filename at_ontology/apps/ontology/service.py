...
from at_ontology_parser.ontology.instances import Vertex, Relationship
from at_ontology_parser.ontology.assignments import PropertyAssignment, ArtifactAssignment
...
class OntologyService(object):
    ...
    def vertices_source_from_db(vertices: Iterable[models.Vertex]) -> dict:
        return {
            vertex.name: OntologyService.vertex_source_from_db(vertex)
    ...
    @staticmethod
    def properties_source_from_db(properties: Iterable[models.VertexPropertyAssignment | models.RelationshipPropertyAssignment]) -> dict:
        result = {}
    ...
    @staticmethod
    def artifacts_source_from_db(artifacts: Iterable[models.VertexArtifactAssignment | models.RelationshipArtifactAssignment]) -> dict:
        result = {}
    ...
    def ontology_source_from_db(ontology: models.Ontology) -> dict:
        return {
            ...
            "imports": [
                f'<{imp.name}>' for imp in ontology.imports.all()
            ],
    ...
    @staticmethod
    @atomic
    def relationship_artifact_to_db(artifact: ArtifactAssignment, relationship: models.Relationship) -> models.RelationshipArtifactAssignment:
    ...
    @staticmethod
    @atomic
    def relationship_property_to_db(property: PropertyAssignment, relationship: models.Relationship) -> models.RelationshipPropertyAssignment:
    ...
    @staticmethod
    @atomic
    def artifact_content_to_db(artifact_assignment: models.VertexArtifactAssignment | models.RelationshipArtifactAssignment, module: OntologyModule) -> models.VertexArtifactAssignment | models.RelationshipArtifactAssignment:
        ...
        if not isinstance(content, bytes):
            raise CreateOntologyException(_("artifact_content_not_bytes{artifact}").format(artifact=artifact_assignment.path))
